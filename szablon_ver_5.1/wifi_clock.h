...
const char* ssid = "xxxxx";                  // WIFI network SSID
const char* password = "vvvvvvvv";        // WIFI network PASSWORD
String nazwa_ESP = String("ESP_test");     // nazwa ESP w DHCP

IPAddress ip(192, 168, 2, 169);            // where 150 is the desired IP Address. The first three numbers must be the same as the router IP
